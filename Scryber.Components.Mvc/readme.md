...
The scryber engine is an advanced, complete, pdf creation library for dotnet core 8 or dotnet standard 2.0.
It supports the easy definition of documents, pages, content, shapes and images with html as templates and data binding for custom content.
...
- calc and var functions in CSS for relative units, as well as model driven values.
