...
namespace Scryber.Components
{
    ...
    public abstract class PDFComponent : PDFObject, IDisposable, IPDFComponent, IPDFBindableComponent, IPDFLoadableComponent
    {
        ...
        internal protected virtual void UnregisterParent(PDFComponent parent)
        {
            ...
            if (null != parent)
            {
                PDFDocument doc = parent.Document;
                if (null != doc)
        ...
        internal protected virtual void RegisterParent(PDFComponent parent)
        {
        ...
        private PDFDocument _cacheddoc;
        ...
        public PDFDocument Document
        {
            get
            {
                ...
                if (this._cacheddoc == null)
                {
                    ...
                    else if (this is PDFDocument)
                        this._cacheddoc = this as PDFDocument;
                    else
