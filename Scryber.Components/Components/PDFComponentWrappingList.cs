...
namespace Scryber.Components
{
    ...
    public abstract class PDFComponentWrappingList : IPDFComponentWrappingList,  System.Collections.IEnumerable
    {
    ...
    public abstract class PDFComponentWrappingList<T> : PDFComponentWrappingList, ICollection<T> where T : PDFComponent
    {
        ...
        private List<T> BuildAllItems(PDFComponentList content)
        {
        ...
        protected virtual void BuildAllItems(PDFComponentList content, List<T> found)
        {
