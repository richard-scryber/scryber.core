...
namespace Scryber.Components
{
                                                      ...
                                                      IPDFTemplateParser, IPDFXMLParsedDocument, IPDFControlledComponent
    {
        ...
        /// </summary>
        public event PDFComponentRegisteredHandler ComponentRegistered;
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual PDFDocumentInfo CreateDocumentInfo()
        {
        ...
        private PDFDocumentViewPreferences _viewPrefs;

        /// <summary>
        /// Gets or sets the viewer preferences for this document
        /// </summary>
        [PDFElement("Viewer")]
        public PDFDocumentViewPreferences ViewPreferences
        {
            get
            {
                if (null == _viewPrefs)
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual PDFDocumentViewPreferences CreateViewPreferences()
        {
            return new PDFDocumentViewPreferences();
        }
        ...
        private PDFDocumentAdditionList _additions;
        ...
        public PDFDocumentAdditionList Additions
        {
            get
            {
                if (null == _additions)
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual PDFDocumentAdditionList CreateAdditionsList()
        {
            return new PDFDocumentAdditionList(this);
        }
        ...
        private PDFDataComponentList _sources;

        [PDFElement("Data")]
        [PDFArray(typeof(PDFDataComponentBase))]
        public PDFDataComponentList DataSources
        {
            get
            {
        ...
        protected virtual PDFDataComponentList CreateDataList()
        {
            return new PDFDataComponentList(this);
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual PDFPageList CreatePageList()
        {
            return new PDFPageList(this.InnerContent);
        }
        ...
        public virtual void RegisterComponent(PDFComponent comp)
        {
        ...
        /// </summary>
        /// <param name="comp"></param>
        public void UnRegisterComponent(PDFComponent comp)
        {
            if (!string.IsNullOrEmpty(comp.Name))
            {
        ...
        public void ReRegisterComponent(PDFComponent comp, string oldname)
        {
        ...
        public void ReRegisterComponent(PDFComponent comp, string oldname, string newname)
        {
        ...
        /// <returns></returns>
        public PDFImageXObject GetImageResource(string fullpath, PDFComponent owner, bool create)
        {
        ...
        public virtual PDFResource GetResource(string resourceType, PDFComponent owner, string resourceKey, bool create)
        {
        ...
        protected virtual PDFResource CreateAndAddResource(string resourceType, PDFComponent owner, string resourceKey)
        {
            PDFResource created;
        ...
        private PDFImageXObject CreateImageResource(string fullpath, PDFComponent owner)
        {
        ...
        private PDFFontResource CreateFontResource(string fullname, PDFComponent owner)
        {
        ...
        public virtual IXmlNamespaceResolver CreateNamespaceResolver(PDFXmlNamespaceCollection namespaceDeclarations, XmlNameTable nameTable)
        {
            ...
            foreach (PDFXmlNamespaceDeclaration dec in namespaceDeclarations)
            {
        ...
        protected virtual PDFDocument CreateTraceLogAppendDocument(PDFDocumentGenerationData genData, PDFFile origFile, PDFDocument appended)
        {
        ...
        private PDFDocumentGenerationData DoGetGenerationData(long docSize, TimeSpan totalTime, PDFRenderContext context)
        {
            ...
            System.Reflection.Assembly assm = typeof(PDFDocument).Assembly;
        ...
        public static PDFDocument ParseDocument(System.IO.Stream stream, ParseSourceType type)
        {
            PDFReferenceChecker checker = new PDFReferenceChecker(string.Empty);
        ...
        public static PDFDocument ParseDocument(System.IO.TextReader reader, ParseSourceType type)
        {
            PDFReferenceChecker checker = new PDFReferenceChecker(string.Empty);
        ...
        public static PDFDocument ParseDocument(System.Xml.XmlReader reader, ParseSourceType type)
        {
            PDFReferenceChecker checker = new PDFReferenceChecker(string.Empty);
            IPDFComponent parsed = Parse(string.Empty, reader, type, checker.Resolver);
        ...
        private class PDFReferenceChecker
        {
            ...
            public IPDFComponent Resolve(string filepath, string xpathselect, PDFGeneratorSettings settings)
            {
                ...
                try
                {
                    ...
                    {
                        comp = PDFDocument.Parse(fullpath, this.Resolver, settings);
                    }
                    else
                    {
                        ...
                        {
                            if (null != reader)
                                comp = PDFDocument.Parse(fullpath, reader, type, this.Resolver, settings);
                        }
                    }
        ...
        /// </summary>
        private class NameDictionary : Dictionary<string, PDFComponent>
        {
        }
    ...
    public static class PDFDocumentExtensions
    {
        ...
        public static bool TryFindAComponentByID<T>(this Scryber.Components.PDFDocument doc, string id, out T found) where T : Scryber.Components.PDFComponent
        {
            found = doc.FindAComponentById(id) as T;
            return null != found;
        }

        public static bool TryFindAComponentByName<T>(this Scryber.Components.PDFDocument doc, string name, out T found) where T : Scryber.Components.PDFComponent
        {
