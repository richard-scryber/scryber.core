...
namespace Scryber.Components
{
    ...
    public class PDFFormInputField : PDFPanel
    {
        private PDFTextLiteral _innerContent;
        ...
        public string Value
        {
            ...
            set {
                ...
                else
                {
                    if (null == this._innerContent)
                    {
                        this._innerContent = new PDFTextLiteral();
        ...
        public PDFFormInputField() : this(PDFObjectTypes.FormInputField)
        { }

        protected PDFFormInputField(PDFObjectType type) : base(type)
        {

        }


        protected PDFForm GetParentForm(PDFContextBase context)
        {
            var parent = this.Parent;
            while (null != parent && !(parent is PDFForm))
            {
