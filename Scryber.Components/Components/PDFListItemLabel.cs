...
namespace Scryber.Components
{
    ...
    public class PDFListItemLabel : PDFTextLiteral
    {

        public PDFListItemLabel(string text)
            : base(text)
        {
        }

        public PDFListItemLabel() : this(null)
        {
        }
    ...
    public class PDFListBulletItemLabel : PDFListItemLabel
    {
    ...
    public class PDFListDefinitionItemLabel : PDFListItemLabel
    {
