...
namespace Scryber.Components
{
    ...
    /// </summary>
    public class PDFPageAdornment : PDFLayoutTemplateComponent
    {
        public PDFPageAdornment(PDFObjectType type)
            : base(type)
        {
        }
    ...
    public class PDFPageHeader : PDFPageAdornment
    {
    ...
    public class PDFPageFooter : PDFPageAdornment
    {
