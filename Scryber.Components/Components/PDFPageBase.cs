...
{
    public abstract class PDFPageBase : PDFVisualComponent, IPDFStyledComponent, IPDFResourceContainer, IPDFViewPortComponent,
                                                  IPDFRemoteComponent, IPDFControlledComponent, IPDFNamingContainer, IPDFTopAndTailedComponent
    {
        ...
        /// </summary>
        protected class PageAdornmentHash : Dictionary<int,PDFPageAdornment>
        {
        }
        ...
        protected PDFPageBase(PDFObjectType type)
            : base(type)
        {
        ...
        internal override void RegisterPreLayout(PDFLayoutContext context)
        {
            ...
            {
                foreach (PDFPageAdornment adorn in this.PageHeaders.Values)
                {
            ...
            {
                foreach (PDFPageAdornment adorn in this.PageFooters.Values)
                {
                    adorn.RegisterPreLayout(context);
                }
            }
    ...
    /// </summary>
    public class PDFPageList : PDFComponentWrappingList<PDFPageBase>
    {
