...
namespace Scryber.Components
{
    ...
    public class PDFPageOfLabel: PDFTextBase
    {
        //The found component the shows the page of.
        private PDFComponent _found;
        ...
        private PDFComponent LookupExternalComponent(bool rendering, PDFLayoutContext context, string name)
        {
            PDFComponent comp;
