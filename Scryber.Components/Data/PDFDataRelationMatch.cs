...
namespace Scryber.Data
{
    ...
    public class PDFDataRelationMatch : PDFObject
    {
        ...
        public PDFDataRelationMatch()
            : this(PDFObjectTypes.SqlRelationMappingType)
        {
        }

        protected PDFDataRelationMatch(PDFObjectType type)
            : base(type)
        {
        }
    ...
    /// </summary>
    public class PDFDataRelationMatchList : List<PDFDataRelationMatch>
    {
    }
}
