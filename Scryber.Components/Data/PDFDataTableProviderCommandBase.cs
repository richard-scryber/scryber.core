...
{
    public abstract class PDFDataTableProviderCommandBase : PDFXPathProviderCommandBase, IPDFDataSetProviderCommand
    {
        ...
        [PDFArray(typeof(PDFDataParameter))]
        ...
        /// </summary>
        [PDFArray(typeof(PDFDataRelation))]
        ...
        public PDFDataTableProviderCommandBase(PDFObjectType type) : base(type)
        {
        ...
        /// <returns></returns>
        protected override void DoEnsureDataLoaded(PDFXPathDataSourceBase source, DataSet ds, PDFDataContext context)
        {
            ...
            {
                foreach (PDFDataRelation rel in this.Relations)
                {
        ...
        /// <param name="context"></param>
        public abstract void FillData(DataSet dataset, PDFXPathDataSourceBase source, IPDFDataSetProviderCommand parent, PDFDataContext context);
        ...
        {
            return PDFDataSetSchemaGenerator.CreateSchemaFromSet(dataset, context);
        }
        ...
        /// <param name="source"></param>
        /// <param name="context"></param>
        protected virtual void FillRelatedData(PDFDataRelation rel, DataSet ds, PDFXPathDataSourceBase source, PDFDataContext context)
        {
