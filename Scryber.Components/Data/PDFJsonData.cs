...
namespace Scryber.Data
{
    ...
    public class PDFJsonData : Scryber.Components.PDFPreformatted
    {
        ...
        private Scryber.Components.PDFTextLiteral _literal;
        ...
        protected override void DoDataBind(PDFDataContext context, bool includeChildren)
        {
            ...
            _literal = new Components.PDFTextLiteral();
        ...
        protected override PDFStyle GetBaseStyle()
        {
            ...
            baseStyle.Border.Color = System.Drawing.Color.Coral;
            baseStyle.Background.Color = System.Drawing.Color.Cornsilk;
