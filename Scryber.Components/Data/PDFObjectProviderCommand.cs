...
namespace Scryber.Data
{
    ...
    public class PDFObjectProviderCommand : PDFXPathProviderCommandBase
    {
        //
        // properties
        //
        ...
        [PDFArray(typeof(PDFObjectParameter))]
        ...
        /// </summary>
        public PDFObjectProviderCommand()
        ...
        protected PDFObjectProviderCommand(PDFObjectType type)
            : base(type)
        {
        }
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        protected override void DoEnsureDataLoaded(PDFXPathDataSourceBase source, System.Data.DataSet ds, PDFDataContext context)
        {
        ...
        private object[] GetInvokingParameterValues(MethodInfo meth)
        {
            ...
            for (int i = 0; i < param.Length; i++)
            {
                ...
                PDFObjectParameter objParam = this.Parameters[pi.Name];
                if (null == objParam)
        ...
        /// <returns></returns>
        private MethodInfo AssertGetCallableMethod(PDFXPathDataSourceBase source)
        {
        ...
        private MethodInfo EnsureSignatureMatchesParameters(MethodInfo methodInfo)
        {
            ...
            foreach (PDFObjectParameter op in this.Parameters)
            {
