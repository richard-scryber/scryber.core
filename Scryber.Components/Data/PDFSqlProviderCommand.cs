...
namespace Scryber.Data
{
    ...
    public class PDFSqlProviderCommand : PDFDataTableProviderCommandBase, IPDFDataSetProviderCommand
    {
        ...
        public override void FillData(DataSet ds, PDFXPathDataSourceBase source, IPDFDataSetProviderCommand parent, PDFDataContext context)
        {
            ...
            try
            {
                con = this.CreateConnection(source, parent as PDFSqlProviderCommand);//parent could be null but handled in the code
        ...
        private void PopulateParameters(DbCommand cmd, PDFDataContext context)
        {
            if (this.HasParameters)
            {
                foreach (PDFDataParameter param in this.Parameters)
                {
