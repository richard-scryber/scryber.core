...
namespace Scryber.Data
{
    ...
    /// </summary>
    public abstract class PDFXPathDataSourceBase : PDFDataSourceBase, IPDFContainerComponent
    {
        ...
        private PDFXPathProviderCommandList _cmds;

        /// <summary>
        /// Gets the list of commands in this DataSource
        /// </summary>
        [PDFElement("Commands")]
        [PDFArray(typeof(PDFXPathProviderCommandBase))]
        public PDFXPathProviderCommandList Commands
        {
            get
            {
                if (null == _cmds)
                    _cmds = new PDFXPathProviderCommandList(this);
                return _cmds;
            }
        }
        ...
        private PDFComponentList _contents = null;

        PDFComponentList IPDFContainerComponent.Content
        {
            get {
                if (null == _contents)
                    _contents = new PDFComponentList(this, PDFObjectTypes.XmlData);
                return _contents;
            }
        }
        ...
        public PDFXPathDataSourceBase(PDFObjectType type)
            : base(type)
        {
        }
        ...
        public override PDFDataSchema GetDataSchema(string path, PDFDataContext context)
        {
            ...
            {
                PDFDataSchema schema = PDFDataSetSchemaGenerator.CreateSchemaFromSet(ds, context);
                if (!string.IsNullOrEmpty(path))
                {
