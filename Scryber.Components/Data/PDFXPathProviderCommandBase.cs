...
{
    public abstract class PDFXPathProviderCommandBase : Scryber.Components.PDFComponent
    {
        ...
        public PDFXPathProviderCommandBase(PDFObjectType type)
            : base(type)
        {
        }
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public void EnsureDataLoaded(PDFXPathDataSourceBase source, System.Data.DataSet dataSet, PDFDataContext context)
        {
            try
            {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        protected abstract void DoEnsureDataLoaded(PDFXPathDataSourceBase source, System.Data.DataSet dataSet, PDFDataContext context);


    }


    public class PDFXPathProviderCommandList : Scryber.Components.PDFComponentWrappingList<PDFXPathProviderCommandBase>
    {
        ...
        /// <returns></returns>
        public PDFXPathProviderCommandBase this[string name]
        {
            get
            {
                if (this.Count > 0)
                {
                    foreach (PDFXPathProviderCommandBase cmd in this)
                    {
        ...
        /// </summary>
        public PDFXPathProviderCommandBase Default
        {
            get
            {
                if (this.Count > 0)
        ...
        public PDFXPathProviderCommandList(PDFXPathDataSourceBase parentSource) : base(((IPDFContainerComponent)parentSource).Content)
        {
        }
