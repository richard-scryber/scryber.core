...
namespace Scryber.Data
{
    ...
    public class PDFXmlNamespaceDeclaration : IPDFBindableComponent
    {
        ...
        /// </summary>
        public PDFXmlNamespaceDeclaration()
        {
        }
    ...
    /// </summary>
    public class PDFXmlNamespaceCollection : List<PDFXmlNamespaceDeclaration>
    {
        ...
        public void DataBind(PDFDataContext context)
        {
            if (this.Count > 0)
            {
                foreach (PDFXmlNamespaceDeclaration dec in this)
                {
