...
{
    public class PDFXmlTransformation : IPDFBindableComponent
    {
        ...
        private PDFXsltArgumentList _args;

        /// <summary>
        /// Gets or sets the list of arguments for this transformer
        /// </summary>
        [PDFArray(typeof(PDFXsltArgumentBase))]
        [PDFElement("")]
        public PDFXsltArgumentList Arguments
        {
            get
            {
                if (null == _args)
                    _args = new PDFXsltArgumentList();
                return _args;
            }
            set
            {
        ...
        protected virtual System.Xml.Xsl.XslCompiledTransform DoGetTransformer(int cacheduration, IPDFDataSource source, PDFDataContext context)
        {
            ...
            if (null == _transformer)
            {
                ...
                IPDFCacheProvider cache = ((Scryber.Components.PDFDocument)source.Document).CacheProvider;
        ...
        protected virtual System.Xml.Xsl.XsltArgumentList DoGetArguments(PDFDataContext context)
        {
            ...
            {
                foreach (PDFXsltArgumentBase arg in this.Arguments)
                {
