...
namespace Scryber.Data
{
    ...
    public abstract class PDFXsltArgumentBase : IPDFBindableComponent
    {
        ...
        public static string GetFullName(PDFXsltArgumentBase arg)
        {
            if (null == arg)
    ...
    /// </summary>
    public class PDFXsltArgumentList : List<PDFXsltArgumentBase>
    {
        ...
        public void DataBind(PDFDataContext context)
        {
            if (this.Count > 0)
            {
                foreach (PDFXsltArgumentBase arg in this)
                {
    ...
    public class PDFXsltArgument : PDFXsltArgumentBase
    {
        [PDFAttribute("value")]
        [PDFElement("")]
        public string Value
    ...
    public class PDFXsltQueryStringArgument : PDFXsltArgumentBase
    {
    ...
    public class PDFXsltContextItemArgument : PDFXsltArgumentBase
    {
        [PDFAttribute("default-value")]
        [PDFElement("")]
        public string DefaultValue
