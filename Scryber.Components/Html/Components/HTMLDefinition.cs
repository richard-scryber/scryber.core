...
namespace Scryber.Html.Components
{
    ...
    /// </summary>
    [PDFParsableComponent("defn")]
    public class HTMLDefinition : Scryber.Html.Components.HTMLSpan
    {
        ...
        public HTMLDefinition() : this(HTMLObjectTypes.Definition)
        { }

        protected HTMLDefinition(ObjectType type): base(type)
        { }
