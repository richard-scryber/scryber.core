...
namespace Scryber.Html.Components
{
    ...
    [PDFParsableComponent("menu")]
    public class HTMLListMenu : Scryber.Components.ListUnordered
    {
        [PDFAttribute("class")]
        ...
        public HTMLListMenu()
            : this(HTMLObjectTypes.ListMenu)
        {
        }

        protected HTMLListMenu(ObjectType type) : base(type)
        { }
        ...
        protected override Style GetBaseStyle()
        {
            ...
            style.List.NumberingStyle = ListNumberingGroupStyle.None;
