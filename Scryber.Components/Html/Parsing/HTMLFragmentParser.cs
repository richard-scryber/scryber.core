...
{
    [Obsolete("Please use the Scryber.Html.Parsing.HTMLParser as this is more advanced",false)]
    public class HTMLFragmentParser : IHtmlContentParser, IEnumerable<HTMLParserResult>
    {
        ...
        public HTMLFragmentParser(string text)
        ...
        /// </summary>
        /// <param name="text"></param>
        public HTMLFragmentParser(string text, HTMLParserSettings settings)
        ...
        public HTMLFragmentParser(string text, IParserComponentFactory componentFactory, IParserStyleFactory styleFactory, HTMLParserSettings settings)
        {
