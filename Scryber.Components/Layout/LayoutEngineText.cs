...
namespace Scryber.Layout
{
    ...
    public class LayoutEngineText : IPDFLayoutEngine
    {
        ...
        #region Scryber.Resources.PDFFontResource FontRsrc {get;}

        private Scryber.Resources.PDFFontResource _frsrc;

        /// <summary>
        /// Gets the font resource used for this text component
        /// </summary>
        public Scryber.Resources.PDFFontResource FontRsrc
        {
            get;
            private set;
        }
