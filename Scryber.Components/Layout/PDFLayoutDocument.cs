...
namespace Scryber.Layout
{
    ...
    public partial class PDFLayoutDocument : PDFLayoutContainerItem
    {
        ...
        public PDFPageNumberGroup RegisterPageNumbering(PDFLayoutPage page, PDFPageNumberOptions options)
        {
        ...
        /// <returns></returns>
        public PDFPageNumberData GetNumbering(int pageindex)
        {
