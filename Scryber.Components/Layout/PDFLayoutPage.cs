...
namespace Scryber.Layout
{
    ...
    /// </summary>
    public class PDFLayoutPage : PDFLayoutContainerItem, IPDFResourceContainer
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual PDFPageNumberData GetPageNumber()
        {
        ...
        string IPDFResourceContainer.MapPath(string path)
        {
