...
namespace Scryber.PDF.Layout
{
    ...
    /// </summary>
    public class LayoutEngineCheckState : LayoutEngineFormField
    {
        protected FormFieldAppearanceState AppearanceState { get; set; }
        
        public LayoutEngineCheckState(FormInputField container, IPDFLayoutEngine parent, FormFieldAppearanceState forState) : base(container, parent)
        {
        ...
        protected override void DoLayoutComponent()
        {
            ...
            if (this.AppearanceState != FormFieldAppearanceState.On)
            {
