...
namespace Scryber.PDF.Layout
{
    ...
    /// </summary>
    public class LayoutEngineFormField : LayoutEnginePanel
    {
        ...
        protected bool ShouldProxyText { get; set; }
        
        protected bool ShouldAddXObject { get; set; }
        ...
        public LayoutEngineFormField(FormInputField container, IPDFLayoutEngine parent) :base(container, parent)
        {
        ...
        protected override void DoLayoutComponent()
        {
            ...
            PDFLayoutXObjectRun xObject = null;

            if (this.ShouldAddXObject)
            {
                xObject = this.CreateAndAddInput(pos);
                if (null == xObject)
                {
            ...
            if (this.ShouldProxyText)
            {
                ...
                else if (this.Field.ButtonType == FormButtonFieldType.CheckBox ||
                         this.Field.ButtonType == FormButtonFieldType.Radio)
                {
        ...
        /// </summary>
        protected virtual void RegisterAppearances(PDFLayoutXObjectRun xObject, PDFPositionOptions pos, Point offset = default(Point))
        {
            ...
            {
                this.Field.Widget.ContainerOffset = new Point(offset.X, offset.Y);
            }
        }
