...
{
    private PDFFile RootFile { get; set; }

    private PDFModifyLayoutDocument LayoutDocument { get; set; }
        ...
        : base(parent, forFrame, context)
    {
        ...
        this.LayoutDocument = (PDFModifyLayoutDocument)context.DocumentLayout;
    }
