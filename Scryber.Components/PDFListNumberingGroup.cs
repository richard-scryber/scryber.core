...
namespace Scryber
{
    ...
    /// </summary>
    /// <remarks>A PDFDocument holds all the registered groups, and these are built with the numbering stack</remarks>
    public class PDFListNumberingGroup
    {
    ...
    public class PDFListNumberingImageGroup : PDFListNumberingGroup
    {
    ...
    public class PDFListNumberingStack
    {
        ...
        private List<PDFListNumberingGroup> _items;

        /// <summary>
        /// Gets the current numbering group in this stack
        /// </summary>
        public PDFListNumberingGroup Current
        {
            get
            {
        ...
        {
            this.Name = name;
            this._items = new List<PDFListNumberingGroup>();
        }
