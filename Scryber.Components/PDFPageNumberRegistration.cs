...
namespace Scryber
{
    ...
    /// </summary>
    public class PDFPageNumberRegistration
    {
        private const int UNCLOSED = -1;

        #region public PDFPageNumberGroup Group { get; }

        /// <summary>
        /// Gets the numbering group associated with this registration
        /// </summary>
        public PDFPageNumberGroup Group
        {
            get;
            private set;
        }
        ...
        #region public PDFPageNumberRegistration(int index, PDFPageNumberingGroup grp)
        ...
        public PDFPageNumberRegistration(int index, PDFPageNumberGroup grp)
        {
        ...
        #region public PDFPageNumberRegistration(int startindex, int endindex, PDFPageNumberingGroup grp)
        ...
        /// <param name="index"></param>
        /// <param name="grp"></param>
        public PDFPageNumberRegistration(int startindex, int endindex, PDFPageNumberGroup grp)
        {
