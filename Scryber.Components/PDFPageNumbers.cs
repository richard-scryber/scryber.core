...
namespace Scryber
{
    ...
    /// </summary>
    public class PDFPageNumbers
    {
        #region ivars

        private int _totalpages = -1;

        private PDFPageNumberGroup _default; //The default style
        private PDFPageNumberGroup _lastGroup; //The previous numbering group that needs to be closed at the next registration.
        private int _lastPageIndex; //The index of the last page that was registered or unregistered
        private List<PDFPageNumberRegistration> _registrations; // All the page number style registrations
        private Stack<PDFPageNumberGroup> _route; //A stack of the current numbering styles
        
        private Dictionary<string, PDFPageNumberGroup> _namedGroups;
        #endregion
        ...
        #region public List<PDFPageNumberRegistration> Registrations

        /// <summary>
        /// Gets all the registractions in this collection
        /// </summary>
        public List<PDFPageNumberRegistration> Registrations
        {
        ...
        #region public PDFPageNumberGroup Default

        /// <summary>
        /// Gets the default (root) registration and therfore default numbering group
        /// </summary>
        public PDFPageNumberGroup DefaultGroup
        {
            get { return _default; }
        }
        ...
        #region public PDFPageNumberGroup CurrentGroup

        /// <summary>
        /// Gets the current number grouping for pages
        /// </summary>
        public PDFPageNumberGroup CurrentGroup
        {
            get
            {
        ...
        #region public PDFPageNumbers()

        /// <summary>
        /// Default empty constructor
        /// </summary>
        public PDFPageNumbers()
        {
        ...
        public void UnRegister(int pageIndex)
        {
            ...
            PDFPageNumberGroup grp = this._route.Peek();
