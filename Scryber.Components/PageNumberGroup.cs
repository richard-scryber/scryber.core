...
namespace Scryber
{
    ...
    public class PageNumberGroup
    {
        ...
        #region public PageNumbers Owner { get; set; }

        /// <summary>
        /// Gets the page numbers owner of this group.
        /// </summary>
        public PageNumbers Owner { get; set; }
        ...
        public PageNumberGroup(PageNumbers owner, string groupName, PageNumberStyle style, int startindex)
        {
            this.Owner = owner;
        ...
        public void EndCounting()
        {
            ...
            PageNumberRegistration reg = new PageNumberRegistration(seq.StartPageIndex, seq.EndPageIndex, this);
