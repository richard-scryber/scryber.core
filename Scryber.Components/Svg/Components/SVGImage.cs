...
public class SVGImage : Scryber.Components.Image
{
    ...
    public override Unit X
    {
        ...
        set { this.Style.SetValue(StyleKeys.SVGGeometryXKey, value); }
    }
    ...
    public override Unit Y
    {
        ...
        set { this.Style.SetValue(StyleKeys.SVGGeometryYKey, value); }
    }
    ...
    public override Unit Width
    {
        ...
        set { this.Style.SetValue(StyleKeys.SizeWidthKey, value); }
    }
    ...
    public override Unit Height
    {
        ...
        set { this.Style.SetValue(StyleKeys.SizeHeightKey, value); }
    }
    ...
    public SVGTransformOperationSet Transform
    {
        ...
        set { this.Style.SetValue(StyleKeys.TransformOperationKey, value); }
    }
    ...
    [PDFElement("desc")] public string Description { get; set; }
