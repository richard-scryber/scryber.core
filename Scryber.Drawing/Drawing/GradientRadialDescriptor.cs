...
namespace Scryber.Drawing
{
    public class GradientRadialDescriptor : GradientDescriptor
    {
        ...
        public GradientRadialDescriptor() : this(new List<GradientColor>())
        {
            
        }
        
        public GradientRadialDescriptor(List<GradientColor> colors) : this(colors, RadialShape.Circle, RadialSize.FarthestCorner)
        { }
        ...
        public GradientRadialDescriptor(List<GradientColor> colors, RadialShape shape, RadialSize size) : base(GradientType.Radial)
        {
            ...
            Shape = shape;
            Size = size;
            StartCenter = new Point(0.5, 0.5);
            EndCenter = new Point(0.5, 0.5);
            StartRadius = Unit.Zero;
            EndRadius = new Unit(0.5);
