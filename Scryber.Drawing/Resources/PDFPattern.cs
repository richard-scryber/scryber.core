...
namespace Scryber.Resources
{
    ...
    public abstract class PDFPattern : PDFResource
    {
        ...
        /// </summary>
        public IPDFComponent OwningComponent
        {
            get;
            set;
        }
        ...
        protected PDFPattern(IPDFComponent owner, PatternType type, string fullkey)
            : base(PDFObjectTypes.Pattern)
        {
            ...
            this._key = fullkey;
            this.Container = owner as IPDFResourceContainer;
        }
    ...
    public abstract class PDFTilingPattern : PDFPattern
    {
        ...
        /// <param name="fullkey"></param>
        protected PDFTilingPattern(IPDFComponent container, string fullkey)
