...
namespace Scryber.Styles
{
    ...
    public class PDFFontStyle : PDFStyleItemBase
    {
        ...
        public string FontFamily
        {
            ...
            {
                string found;
                if (this.TryGetValue(PDFStyleKeys.FontFamilyKey, out found))
                    return found;
                else
                    return string.Empty;
            }
            set
            {
                this.SetValue<string>(PDFStyleKeys.FontFamilyKey, value);
            }
        }

        public void RemoveFontFamily()
        {
            this.RemoveValue(PDFStyleKeys.FontFamilyKey);
        }
        ...
        public bool FontBold
        {
            ...
            {
                bool found;
                if (this.TryGetValue(PDFStyleKeys.FontBoldKey, out found))
                    return found;
                else
                    return false;
            }
            set
            {
                this.SetValue(PDFStyleKeys.FontBoldKey, value);
            }
        }

        public void RemoveFontBold()
        {
            this.RemoveValue(PDFStyleKeys.FontBoldKey);
        }
        ...
        public bool FontItalic
        {
            ...
            {
                bool found;
                if (this.TryGetValue(PDFStyleKeys.FontItalicKey, out found))
                    return found;
                else
                    return false;
            }
            set
            {
                this.SetValue(PDFStyleKeys.FontItalicKey, value);
            }
        }

        public void RemoveFontItalic()
        {
            this.RemoveValue(PDFStyleKeys.FontItalicKey);
        }
        ...
        public PDFUnit FontSize
        {
            ...
            {
                PDFUnit found;
                if (this.TryGetValue(PDFStyleKeys.FontSizeKey, out found))
                    return found;
                else
                    return PDFUnit.Zero;
            }
            set
            {
                this.SetValue(PDFStyleKeys.FontSizeKey, value);
            }
        }

        public void RemoveFontSize()
        {
            this.RemoveValue(PDFStyleKeys.FontSizeKey);
        }

        #endregion

        public PDFFontStyle()
            : base(PDFStyleKeys.FontItemKey)
        {
        }
