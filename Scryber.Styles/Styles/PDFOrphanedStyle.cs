...
namespace Scryber.Styles
{
    ...
    /// </summary>
    internal class PDFOrphanedStyle : PDFStyleBase
    {
        private PDFOrphanedStylePool _orphanPool;

        internal PDFOrphanedStyle(PDFOrphanedStylePool pool)
        ...
        internal static PDFOrphanedStylePool Pool
        {
