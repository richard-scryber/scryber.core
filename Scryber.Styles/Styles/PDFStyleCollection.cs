...
namespace Scryber.Styles
{
    ...
    /// </summary>
    public class PDFStyleCollection : System.Collections.ObjectModel.Collection<PDFStyleBase>
    {
        ...
        public PDFStyleCollection()
            : this(null, false)
        { }

        public PDFStyleCollection(IPDFComponent owner)
            : this(owner, true)
        {
            
        }

        protected PDFStyleCollection(IPDFComponent owner, bool hasowner)
        {
            this.Owner = owner;
        ...
        {
            foreach (PDFStyleBase item in this)
            {
        ...
        protected override void SetItem(int index, PDFStyleBase item)
        {
        ...
        protected override void InsertItem(int index, PDFStyleBase item)
        {
