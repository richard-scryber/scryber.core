...
namespace Scryber.Styles
{
    ...
    /// </summary>
    public abstract class PDFStyleItemBase : Scryber.PDFObject, IPDFBindableComponent
    {
        ...
        {
            get { return _owner == null || _owner is PDFOrphanedStyle; }
        }
        ...
        private PDFStyleKey _itemkey;

        /// <summary>
        /// Gets the style key associated with this item
        /// </summary>
        public PDFStyleKey ItemKey
        {
            get { return _itemkey; }
        }
        ...
        protected PDFStyleItemBase(PDFStyleKey key)
        ...
        /// <returns></returns>
        public bool IsDefined(PDFStyleKey valuekey)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public PDFStyleBase AssertOwner()
        {
            if (null == this._owner)
                    this._owner = PDFOrphanedStyle.Pool.Get();
    ...
    public static class StyleItemBaseExtensions
    {
        ...
        public static bool TryGetValue<T>(this PDFStyleItemBase itembase, PDFStyleKey<T> key, out T found)
        {
            PDFStyleValue<T> exist;
        ...
        public static void SetValue<T>(this PDFStyleItemBase itembase, PDFStyleKey<T> key, T value)
        {
            ...
            {
                found = new PDFStyleValue<T>(key, value);
