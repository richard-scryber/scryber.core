...
namespace Scryber.Styles
{
    ...
    /// </remarks>
    public class PDFStyleKey : IComparable<PDFStyleKey>, IEquatable<PDFStyleKey>
    {
        #region ivars
        ...
        protected PDFStyleKey(int fullhash, PDFObjectType item, PDFObjectType value, bool inherited, bool isItem)
        {
        ...
        {
            if (obj is PDFStyleKey)
            {
                PDFStyleKey other = (PDFStyleKey)obj;
        ...
        /// <returns></returns>
        public int CompareTo(PDFStyleKey other)
        {
        ...
        /// <param name="other"></param>
        /// <returns></returns>
        public bool Equals(PDFStyleKey other)
        {
            return this._fullhash == other._fullhash;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static IEqualityComparer<PDFStyleKey> GetComparer()
        {
            return _comparer;
        }
        ...
        /// </summary>
        private static IEqualityComparer<PDFStyleKey> _comparer = new StyleKeyHashComparer();
        ...
        /// </summary>
        private class StyleKeyHashComparer : IEqualityComparer<PDFStyleKey>
        {
            public bool Equals(PDFStyleKey x, PDFStyleKey y)
            {
                return x._fullhash == y._fullhash;
            }

            public int GetHashCode(PDFStyleKey obj)
            {
        ...
        /// <returns></returns>
        public static PDFStyleKey CreateStyleItemKey(PDFObjectType item, bool inherited)
        {
            string full = GetStyleKeyAsString(item, StyleItemIdentifier);
            int hash = GetStyleHash(full);

            return new PDFStyleKey(hash, item, StyleItemIdentifier, inherited, true);
        }
        ...
        /// <returns></returns>
        public static PDFStyleKey<T> CreateStyleValueKey<T>(PDFObjectType name, PDFStyleKey foritem)
        {
        ...
        internal static PDFStyleKey InternalCreateStyleItemKey(PDFObjectType item, bool inherited)
        {
            string full = GetStyleKeyAsString(item, StyleItemIdentifier);
        ...
        internal static PDFStyleKey<T> InternalCreateStyleValueKey<T>(PDFObjectType name, PDFStyleKey foritem)
        {
            if (foritem.IsItemKey == false)
                throw new InvalidOperationException("forItem is not an item");
    ...
    public class PDFStyleKey<T> : PDFStyleKey
    {
    ...
    /// The 
    /// </summary>
    public class StyleValueDictionary : Dictionary<PDFStyleKey, PDFStyleValueBase>
    {
        public StyleValueDictionary()
            : base(PDFStyleKey.GetComparer())
        {
        }
