...
namespace Scryber.Styles
{
    ...
    public class PDFTransformStyle : PDFStyleItemBase
    {
        ...
        public float ScaleX
        {
            ...
            {
                float f;
                if (this.TryGetValue(PDFStyleKeys.TransformXScaleKey, out f))
                    return f;
                else
                    return 1.0F;
            ...
            set
            {
                this.SetValue(PDFStyleKeys.TransformXScaleKey, value);
            }
        }

        public void RemoveScaleX()
        {
            this.RemoveValue(PDFStyleKeys.TransformXScaleKey);
        }
        ...
        public float ScaleY
        {
            ...
            {
                float f;
                if (this.TryGetValue(PDFStyleKeys.TransformYScaleKey, out f))
                    return f;
                else
                    return 1.0F;
            ...
            set
            {
                this.SetValue(PDFStyleKeys.TransformYScaleKey, value);
            }
        }

        public void RemoveScaleY()
        {
            this.RemoveValue(PDFStyleKeys.TransformYScaleKey);
        }
        ...
        public float Rotate
        {
            ...
            {
                float f;
                if (this.TryGetValue(PDFStyleKeys.TransformRotateKey, out f))
                    return f;
                else
                    return 0.0F;
            ...
            set
            {
                this.SetValue(PDFStyleKeys.TransformRotateKey, value);
            }
        }

        public void RemoveRotate()
        {
            this.RemoveValue(PDFStyleKeys.TransformRotateKey);
        }
        ...
        public float SkewX
        {
            ...
            {
                float f;
                if (this.TryGetValue(PDFStyleKeys.TransformXSkewKey, out f))
                    return f;
                else
                    return 0.0F;
            ...
            set
            {
                this.SetValue(PDFStyleKeys.TransformXSkewKey, value);
            }
        }

        public void RemoveSkewX()
        {
            this.RemoveValue(PDFStyleKeys.TransformXSkewKey);
        }
        ...
        public float SkewY
        {
            ...
            {
                float f;
                if (this.TryGetValue(PDFStyleKeys.TransformYSkewKey, out f))
                    return f;
                else
                    return 0.0F;
            ...
            set
            {
                this.SetValue(PDFStyleKeys.TransformYSkewKey, value);
            }
        }

        public void RemoveSkewY()
        {
            this.RemoveValue(PDFStyleKeys.TransformYSkewKey);
        }
        ...
        */
        ...
        public PDFTransformStyle()
            : base(PDFStyleKeys.TransformItemKey)
        {
        }
