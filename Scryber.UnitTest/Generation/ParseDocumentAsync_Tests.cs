...
namespace Scryber.Core.UnitTests.Generation
{
    ...
    /// </summary>
    [TestClass()]
    public class ParseDocumentAsync_Tests
    {
        ...
        public async Task ParseXHTMLLocalFileAsync()
        {
            ...
            using (Document doc = await Document.ParseDocumentAsync(fullpath))
            {
                doc.Params["title"] = "Hello World & everyone in it.";
                using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_LocalXhtml.pdf"))
                {
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXHTMLRelativeFileAsync()
        {
            ...
            using (Document doc = await Document.ParseDocumentAsync(fullpath))
            {
                ...
                using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_RelativeXhtml.pdf"))
                {
                    await doc.SaveAsPDFAsync(ms);
                }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXHTMLStreamAsync()
        {
            var fullpath = DocStreams.AssertGetTemplatePath("HTML/HelloWorld.xhtml");
            ...
            {
                using (Document doc = await Document.ParseDocumentAsync(stream))
                {
                    doc.Params["title"] = "Hello World & everyone in it.";

                    using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_StreamXhtml.pdf"))
                    {
                        await doc.SaveAsPDFAsync(ms);
                    }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXHTMLTextReaderAsync()
        {
            var fullpath = DocStreams.AssertGetTemplatePath("HTML/HelloWorld.xhtml");
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                ...
                {
                    using (Document doc = await Document.ParseDocumentAsync(reader))
                    {
                        doc.Params["title"] = "Hello World & everyone in it.";

                        using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_TextReaderXhtml.pdf"))
                        {
                            await doc.SaveAsPDFAsync(ms);
                        }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXHTMLXmlReaderAsync()
        {
                ...
                using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
                {
                    ...
                    using (var reader = System.Xml.XmlReader.Create(stream, settings))
                    {
                        using (Document doc = await Document.ParseDocumentAsync(reader))
                        {
                            ...
                            using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_XmlReaderXhtml.pdf"))
                            {
                                await doc.SaveAsPDFAsync(ms);
                            }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXHTMLStreamWithRelativePathAsync()
        {
            var fullpath = DocStreams.AssertGetTemplatePath("HTML/HelloWorld.xhtml");
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                ...
                using (Document doc = await Document.ParseDocumentAsync(stream, fullpath, ParseSourceType.LocalFile))
                {
                    doc.Params["title"] = "Hello World & everyone in it.";

                    using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_StreamRelativePathXhtml.pdf"))
                    {
                        await doc.SaveAsPDFAsync(ms);
                    }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXHTMLStreamWithRemotePathAsync()
        {
            ...
            using (var client = new System.Net.Http.HttpClient())
            {
                ...
                {
                    //Pass the relative path to the parsing
                    using (Document doc = await Document.ParseDocumentAsync(stream, remote, ParseSourceType.RemoteFile))
                    {
                        doc.Params["title"] = "Hello World & everyone in it.";

                        using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_StreamRemotePathXhtml.pdf"))
                        {
                            await doc.SaveAsPDFAsync(ms);
                        }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXHTMLTextReaderWithRelativePathAsync()
        {
            var fullpath = DocStreams.AssertGetTemplatePath("HTML/HelloWorld.xhtml");
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                ...
                {
                    //Pass the relative path to the parsing
                    using (Document doc = await Document.ParseDocumentAsync(reader, fullpath, ParseSourceType.LocalFile))
                    {
                        doc.Params["title"] = "Hello World & everyone in it.";

                        using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_TextReaderRelativePathXhtml.pdf"))
                        {
                            await doc.SaveAsPDFAsync(ms);
                        }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXHTMLXmlReaderWithRelativePathAsync()
        {
                ...
                using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
                {
                    ...
                    using (var reader = System.Xml.XmlReader.Create(stream, settings))
                    {
                        using (Document doc = await Document.ParseDocumentAsync(reader, fullpath, ParseSourceType.LocalFile))
                        {
                            ...
                            using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_XmlReaderRelativePathXhtml.pdf"))
                            {
                                await doc.SaveAsPDFAsync(ms);
                            }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXMLLocalFileAsync()
        {
            ...
            using (Document doc = await Document.ParseDocumentAsync(fullpath))
            {
                ...
                using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_LocalXml.pdf"))
                {
                    await doc.SaveAsPDFAsync(ms);
                }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXMLRelativeFileAsync()
        {
            ...
            using (Document doc = await Document.ParseDocumentAsync(relative))
            {
                doc.Params["title"] = "Hello World & everyone in it.";

                using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_RelativeXml.pdf"))
                {
                    await doc.SaveAsPDFAsync(ms);
                }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXMLStreamAsync()
        {
            var relative = "HTML/HelloWorld.xml";
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                using (Document doc = await Document.ParseDocumentAsync(stream))
                {
                    ...
                    using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_StreamXml.pdf"))
                    {
                        await doc.SaveAsPDFAsync(ms);
                    }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXMLTextReaderAsync()
        {
            var relative = "HTML/HelloWorld.xml";
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                using (var reader = new StreamReader(stream))
                {
                    using (Document doc = await Document.ParseDocumentAsync(reader))
                    {
                        ...
                        using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_TextReaderXml.pdf"))
                        {
                            await doc.SaveAsPDFAsync(ms);
                        }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXMLXmlReaderAsync()
        {
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXMLStreamWithRelativePathAsync()
        {
            var relative = "HTML/HelloWorld.xml";
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                ...
                using (Document doc = await Document.ParseDocumentAsync(stream, fullpath, ParseSourceType.LocalFile))
                {
                    ...
                    using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_StreamRelativePathXml.pdf"))
                    {
                        await doc.SaveAsPDFAsync(ms);
                    }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXMLTextReaderWithRelativePathAsync()
        {
            var relative = "HTML/HelloWorld.xml";
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                using (var reader = new StreamReader(stream))
                {
                    ...
                    using (Document doc = await Document.ParseDocumentAsync(reader, fullpath, ParseSourceType.LocalFile))
                    {
                        ...
                        using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_TextReaderRelativePathXml.pdf"))
                        {
                            await doc.SaveAsPDFAsync(ms);
                        }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseXMLXmlReaderWithRelativePathAsync()
        {
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                ...
                using (var reader = System.Xml.XmlReader.Create(stream, settings))
                {
                    using (Document doc = await Document.ParseDocumentAsync(reader, fullpath, ParseSourceType.LocalFile))
                    {
                        ...
                        using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_XmlReaderRelativePathXml.pdf"))
                        {
                            await doc.SaveAsPDFAsync(ms);
                        }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseHtmlLocalFileAsync()
        {
            
            var relative = "HTML/HelloWorld.html";
            ...
            using (Document doc = await Document.ParseHtmlDocumentAsync(fullpath))
            {
                doc.Params["title"] = "Hello World & everyone in it.";

                using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_LocalHtml.pdf"))
                {
                    await doc.SaveAsPDFAsync(ms);
                }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseHtmlRelativeFileAsync()
        {
            ...
            using (Document doc = await Document.ParseHtmlDocumentAsync(relative))
            {
                doc.Params["title"] = "Hello World & everyone in it.";

                using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_RelativeHtml.pdf"))
                {
                    await doc.SaveAsPDFAsync(ms);
                }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseHtmlStreamAsync()
        {
            var relative = "HTML/HelloWorld.html";
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                using (Document doc = await Document.ParseHtmlDocumentAsync(stream))
                {
                    doc.Params["title"] = "Hello World & everyone in it.";

                    using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_StreamHtml.pdf"))
                    {
                        await doc.SaveAsPDFAsync(ms);
                    }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseHtmlTextReaderAsync()
        {
            var relative = "HTML/HelloWorld.html";
            ...
            using (var stream = new System.IO.FileStream(fullpath, System.IO.FileMode.Open))
            {
                using (var reader = new StreamReader(stream))
                {
                    using (Document doc = await Document.ParseHtmlDocumentAsync(reader))
                    {
                        doc.Params["title"] = "Hello World & everyone in it.";

                        using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_TextReaderHtml.pdf"))
                        {
                            await doc.SaveAsPDFAsync(ms);
                        }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseHtmlStreamWithRelativePathAsync()
        {
            var relative = "../../../Content/HTML/HelloWorld.html";
            ...
            {
                //Pass the relative path to the parsing
                using (Document doc = await Document.ParseHtmlDocumentAsync(stream, relative, ParseSourceType.LocalFile))
                {
                    doc.Params["title"] = "Hello World & everyone in it.";

                    using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_StreamRelativePathHtml.pdf"))
                    {
                        await doc.SaveAsPDFAsync(ms);
                    }
        ...
        [TestMethod()]
        [TestCategory("Document")]
        public async Task ParseHtmlStreamWithRemotePathAsync()
        {
            ...
            using (var client = new System.Net.Http.HttpClient())
            {
                ...
                {
                    //Pass the relative path to the parsing
                    using (Document doc = await Document.ParseHtmlDocumentAsync(stream, remote, ParseSourceType.RemoteFile))
                    {
                        doc.Params["title"] = "Hello World & everyone in it.";

                        using (var ms = DocStreams.GetOutputStream("Async_HelloWorld_StreamRemotePathHtml.pdf"))
                        {
                            await doc.SaveAsPDFAsync(ms);
                        }
