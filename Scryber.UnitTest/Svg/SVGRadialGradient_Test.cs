...
namespace Scryber.Core.UnitTests.Svg
{
    ...
    ///</summary>
    [TestClass()]
    public class SVGRadialGradient_Test
    {
        ...
        [TestMethod()]
        public void SVGRadialGradientBrushes_Test()
        {
            ...
            using(var stream = DocStreams.GetOutputStream("SVG_RadialGradientBrushes.pdf"))
            {
            ...
            for (int i = 0; i < 5; i++)
            {
                var pattern = patterns[i] as PDFRadialShadingPattern;
