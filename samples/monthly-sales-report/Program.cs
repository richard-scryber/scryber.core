...
namespace Scryber.Samples.MonthlySalesReport
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("==============================================");
                Console.WriteLine("  Scryber Monthly Sales Report Generator");
                Console.WriteLine("==============================================");
                Console.WriteLine();

                // Parse arguments
                string dataFile = args.Length > 0 ? args[0] : "data/monthly-sales-sample.json";
                string outputFile = args.Length > 1 ? args[1] : "output/monthly-sales-report.pdf";
                string templateFile = "templates/monthly-sales-report.html";
                ...
                Console.WriteLine();
                Console.WriteLine("Open the PDF to view your sales report.");
                Console.WriteLine();
            }
            catch (Exception ex)
            {
